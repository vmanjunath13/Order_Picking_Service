...
public class KafkaProducerConfiguration {
    ...
    @Bean
    public ProducerFactory<String, OrderPickUpDto> producerFactoryJson() throws UnknownHostException {
        ...
        DefaultKafkaProducerFactory<String, OrderPickUpDto> factory = new DefaultKafkaProducerFactory<>(configProps);
    ...
    @Bean
    public KafkaTemplate<String, OrderPickUpDto> kafkaTemplateJson() throws UnknownHostException{
